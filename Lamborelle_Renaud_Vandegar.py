...
if __name__ == '__main__':
    ...
    train_data = pd.merge(training_user_movie_pairs,training_movies_attributes)
    train_data = pd.merge(train_data,training_users_attributes)
    train_data = train_data.drop(['movie_title', 'video_release_date','IMDb_URL','zip_code','release_date'], axis=1)
    ...
    test_data = pd.merge(test_user_movie_pairs,training_movies_attributes)
    test_data = pd.merge(test_data,training_users_attributes)
    test_data = test_data.drop(['movie_title', 'video_release_date','IMDb_URL','zip_code','release_date'], axis=1)
